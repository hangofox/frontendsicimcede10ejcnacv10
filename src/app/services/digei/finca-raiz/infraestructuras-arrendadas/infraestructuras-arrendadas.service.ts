...
export class InfraestructurasArrendadasService {
  ...
  findAllRentedInfrastructures(id?: number, keyword?: string, orderBy?: string, orderMode = 'ASC'): Observable<InfraestructurasArrendadasI[]> { let params = this.params(id, keyword).set('orderMode', orderMode); if (orderBy) params = params.set('orderBy', orderBy); return this.http.get<InfraestructurasArrendadasI[]>(`${this.baseUrl}/infraestructurasArrendadas/lista`, { params }); }
  findAllRentedInfrastructuresPag(page = 0, size = 10, id?: number, keyword?: string, orderBy?: string, orderMode = 'ASC'): Observable<InfraestructurasArrendadasI[]> { let params = this.params(id, keyword).set('page', page).set('size', size).set('orderMode', orderMode); if (orderBy) params = params.set('orderBy', orderBy); return this.http.get<{content: InfraestructurasArrendadasI[]}>(`${this.baseUrl}/infraestructurasArrendadas/listaPag`, { params }).pipe(map(x => x.content)); }
  getRentedInfrastructurebyId(id: number): Observable<ResponseInfraestructuraArrendadaDTO> { return this.http.get<ResponseInfraestructuraArrendadaDTO>(`${this.baseUrl}/infraestructurasArrendadas/${id}`); }
  addRentedInfrastructure(value: InfraestructurasArrendadasI): Observable<InfraestructurasArrendadasMsj> { return this.http.post<InfraestructurasArrendadasMsj>(`${this.baseUrl}/infraestructurasArrendadas`, value); }
  updateRentedInfrastructure(value: InfraestructurasArrendadasI): Observable<InfraestructurasArrendadasMsj> { return this.http.put<InfraestructurasArrendadasMsj>(`${this.baseUrl}/infraestructurasArrendadas`, value); }
  deleteRentedInfrastructure(id: number): Observable<InfraestructurasArrendadasMsj> { return this.http.delete<InfraestructurasArrendadasMsj>(`${this.baseUrl}/infraestructurasArrendadas/${id}`); }
